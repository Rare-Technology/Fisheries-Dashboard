def sync_select_all(all_selected, input_id, selected, all_options, triggered_id):
    """
    ...
    input_id: The id of the dcc input, usually a dcc.Dropdown. Matches the Input in the callback.
